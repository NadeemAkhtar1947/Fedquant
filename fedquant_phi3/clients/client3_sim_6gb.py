...
print("CLIENT 3 — Simulated 6GB Phone")

# ── Step 1: Load Data ──────────────────────────────
print("\n[Step 1] Loading data...")
with open("./data/clients/client3.json", "r", encoding="utf-8") as f:
    data = json.load(f)
data = data
...
print("Saved to ./results/adapters/client3")

print("CLIENT 3 DONE — Adapter ready to send to server")
